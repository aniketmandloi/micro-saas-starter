...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_ENABLE_ERROR_REPORTING: z
    ...
    .default("true")
    .transform((val) => val === "true"),
  NEXT_PUBLIC_ENABLE_FEATURE_FLAGS: z
    .string()
    .default("true")
    .transform((val) => val === "true"),
  NEXT_PUBLIC_ENABLE_MONITORING_DEMO: z
    .string()
    .default("true")
    .transform((val) => val === "true"),
  ...
  DEFAULT_RATE_LIMIT_PER_HOUR: z.string().default("1000").transform(Number),
  DEFAULT_RATE_LIMIT_PER_MINUTE: z.string().default("100").transform(Number),

  // Monitoring Configuration
  DEFAULT_MONITOR_INTERVAL: z.string().default("300").transform(Number),
  DEFAULT_MONITOR_TIMEOUT: z.string().default("30").transform(Number),
...
const processEnv = {
  ...
  NEXT_PUBLIC_ENABLE_FEATURE_FLAGS:
    process.env.NEXT_PUBLIC_ENABLE_FEATURE_FLAGS,
  NEXT_PUBLIC_ENABLE_MONITORING_DEMO:
    process.env.NEXT_PUBLIC_ENABLE_MONITORING_DEMO,
...
export const validateRequiredServices = (
  required: (keyof ReturnType<typeof getServiceStatus>)[]
) => {
